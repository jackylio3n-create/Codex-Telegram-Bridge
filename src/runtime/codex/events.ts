...
export function parseCodexJsonEventLine(line: string): CodexNormalizedEvent | null {
  try {
    ...
    switch (rawType) {
      ...
      case "exec_approval_request":
        if (isStringArray(parsed.command) && typeof parsed.call_id === "string" && typeof parsed.cwd === "string") {
          return {
            kind: "approval_request",
            callId: parsed.call_id,
            approvalId: typeof parsed.approval_id === "string" ? parsed.approval_id : null,
            turnId: typeof parsed.turn_id === "string" ? parsed.turn_id : null,
            command: parsed.command,
            cwd: parsed.cwd,
            reason: typeof parsed.reason === "string" ? parsed.reason : null,
            summary: formatApprovalSummary(parsed.command, typeof parsed.reason === "string" ? parsed.reason : null),
            rawType
          };
        }
        break;
      ...
      case "exec_command_end":
        if (isStringArray(parsed.command) && typeof parsed.call_id === "string" && typeof parsed.cwd === "string") {
          return {
            ...
            aggregatedOutput: typeof parsed.aggregated_output === "string" ? parsed.aggregated_output : "",
      ...
      case "patch_apply_begin":
        if (typeof parsed.call_id === "string" && parsed.changes && typeof parsed.changes === "object") {
          return {
            kind: "patch_apply_begin",
            callId: parsed.call_id,
            turnId: typeof parsed.turn_id === "string" ? parsed.turn_id : null,
            changedPaths: Object.keys(parsed.changes as Record<string, unknown>),
            rawType
          };
        }
        break;
...
export function buildPromptWithRollingSummary(prompt: string, rollingSummary?: string | null): string {
...
function formatApprovalSummary(command: readonly string[], reason: string | null): string {
